    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            if (command.equals("points")) {
                ...
                System.out.println("Which player: ");// Ask the user first which player's statistics are needed and then print them.
                String playersName = reader.nextLine();
                NHLStatistics.searchByPlayer(playersName);
